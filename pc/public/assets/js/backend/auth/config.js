define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'auth/config/index',
                    add_url: 'auth/config/add',
                    edit_url: 'auth/config/edit',
                    del_url: 'auth/config/del',
                    multi_url: 'auth/config/multi',
                    table: 'config',
                }
            });
